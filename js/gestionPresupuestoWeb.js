...
divP.innerHTML = "";
        ...
        for(let value of Object.keys(agrup))
        {
             ...
             valor.innerHTML +=  `${value.valueOf()}   ${idElemento}`;
             divDat.append(valor);
...
function repintar()
{
    ...
    gp.agruparGastos("agrupacion-dia", mostrarGastosAgrupadosWeb());

    document.getElementById("agrupacion-mes");
    gp.agruparGastos("agrupacion-mes", mostrarGastosAgrupadosWeb());
    
    document.getElementById("agrupacion-anyo");
    gp.agruparGastos("agrupacion-anyo", mostrarGastosAgrupadosWeb());
